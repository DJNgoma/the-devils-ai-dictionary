...
const entries: SearchableEntry[] = [
  {
    ...
    searchText: "agent software agent core concepts system act instructions",
    slug: "agent",
    technicalDepth: "low",
    title: "Agent",
  ...
  },
  {
    ...
    searchText: "copilot microsoft assistant product and vendor terms microsoft ai product brand",
